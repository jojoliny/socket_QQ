...
public class MyRecord6 extends JFrame implements MouseListener {
	...
	public MyRecord6() {
		...
		// 设置窗口上的图标
		Image img = this.getToolkit().getImage(getClass().getResource("image/g1.jpg"));
	...
	public void save() {
		...
		try {
			...
			try {
				...
				Process p = run.exec(filePath + "/" + "lame -b 16 " + filePath + "/" + file.getName() + " " + tarPath
				...
				// //定义最终要存放的文件路径
				// String destPath = "D:/Program
				// Files/apache-tomcat-6.0.35/webapps/XWZ/tempFile/";
